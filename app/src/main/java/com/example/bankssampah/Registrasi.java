...
public class Registrasi extends AppCompatActivity {
    ...
    void registrasi(){
        ...
        String nik = niks.getText().toString();
        ...
        if(uName.isEmpty()){
            ...
            register(uName, namaLengkaps,email,nik,alamat,noHp, pass);
        }
    }
    ...
    public void register(final String username, final String namaLengkaps, final String email, final String nik, final String alamat, final String noHp, final String password){
